...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        commandManager.register(new SwordCommand());
        commandManager.register(new SetCommand());
        commandManager.register(new DataGetCommand());
        ...
        minecraftServer.start("0.0.0.0", 25575, PlayerInit.getResponseDataConsumer());
    }
